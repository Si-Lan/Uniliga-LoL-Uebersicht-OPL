...
ini_set("error_log", "cron_logs/cron_errors/calc_champs_$day.log");
...
echo "\n---- calculate Champions of Players \n";
file_put_contents("cron_logs/cron_log_$day.log","\n----- calculating Champions starting -----\n".date("d.m.y H:i:s")." : calculating Champions for $tournament_id\n", FILE_APPEND);
...
echo "-------- Champions for ".$players_updated." Players updated\n";
file_put_contents("cron_logs/cron_log_$day.log","Champions for $players_updated Players updated\n"."----- calculating Champions done -----\n", FILE_APPEND);