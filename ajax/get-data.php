...
if ($type == "match-games-teams-by-matchid") {
	...
	$games = $dbcn->execute_query("SELECT games.RIOT_matchID, gtm.OPL_ID_matches AS OPL_ID_match FROM games JOIN games_to_matches gtm on games.RIOT_matchID = gtm.RIOT_matchID WHERE OPL_ID_matches = ? ORDER BY played_at",[$matchID])->fetch_all(MYSQLI_ASSOC);
