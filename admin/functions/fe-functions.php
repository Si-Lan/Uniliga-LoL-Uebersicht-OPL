...
function create_tournament_buttons(mysqli $dbcn):string {
	...
	foreach ($tournaments as $tournament) {
		...
		$result .= "<div class='turnier-sl-accordeon {$tournament["OPL_ID"]}'>";
		...
		foreach ($leagues as $league) {
			...
			$result .= "<div class='turnier-sl-accordeon {$league["OPL_ID"]}'>";
		...
		$result .= "<div class='turnier-sl-accordeon playoffs'>";
